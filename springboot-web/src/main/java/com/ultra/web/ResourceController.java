...
public class ResourceController extends BaseController<ResourceService, Resource> {
    ...
    @PostMapping
    public boolean save(@Validated @RequestBody Resource entity, Errors errors) {
        return super.save(entity);
    }

    @ApiOperation(value = "更新")
    @PutMapping
    public boolean updateById(@Validated({ UpdateGroup.class }) @RequestBody Resource entity, Errors errors) {
